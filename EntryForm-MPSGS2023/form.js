...
function clearAuxCheckbox() {
    document.getElementById("Auxillary").checked = false;
    return true;
}
...
function togglePaymentOptions() {
    ...
    const auxChecked = document.getElementById("Auxillary").checked;
...
function EmeritusSetup(e) {
    const auxChecked = clearAuxCheckbox();
    const boardChecked = clearBoardCheckbox();

    
    if(auxChecked && boardChecked) {
...
function AuxillarySetup(e) {
    const emeritusChecked = clearEmeritusCheckbox();
    const boardChecked = clearBoardCheckbox();

    if (emeritusChecked && boardChecked) {
        togglePaymentOptions();
